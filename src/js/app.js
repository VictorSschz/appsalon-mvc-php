...
function iniciarApp(){
    ...
    seleccionarFecha();// añadede la fecha de la cita en el objeto
...
function seleccionarServicio(servicio){
    ...
    //comprueba si el servicio está seleccionado o no lo está
    //este codigo haría lo mismo que todo el siguiente IF
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true){
    ...
    //Previene que se gerenen más de 1 alerta
...
function mostrarResumen(){
    ...
    //crear boton para reservar cita
